...
В этой главе применим схемы MPC из глав \ref{chap2} и \ref{chap3} и приведём результаты, полученные программными реализациями алгортимов \ref{Alg1} и \ref{Alg2}.
...
Результаты программной реализации алгоритма (\ref{Alg1}):
\begin{figure}[bh]\centering{
\includegraphics[width=150mm]{chap2.eps}
}
\end{figure}
