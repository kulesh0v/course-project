...
Применение схемы MPC из  Главы \ref{chap2} может привести к проблемам с существованием решения или может сделать замкнутый контур неустойчивым. В этой главе  мы решаем проблему зашумленных измерений с помощью робастной схемы MPC с терминальными ограничениями.
